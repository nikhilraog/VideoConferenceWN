...
public class TransmitterMain implements ReceiveStreamListener, RemoteListener,ControllerListener{
   ...
   // Can be a file or http or capture source
    ...
    public TransmitterMain( Transmit transmitter, int data_port) {
    ...
    // Adding the Target port for the rtcpmanager tracking
	...
	try {
	    ...
	    transmitter.addTargetToList( localPort + "", ip, port + "");
	} catch( Exception e) {
	    e.printStackTrace();
	}
    }
    ...
    // To set out the media events & to playback the media
	...
	transmitter.rtcpReport( sb.toString());	
    }    
